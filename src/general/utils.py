from src.restaurants.models import RestaurantReview
from .functions import *


def update_restaurant_review(review):
    try:
        ...
        r_review.status = get_review_status(r_review.average)
        r_stars = get_stars(r_review.average)
